...
def test_string_methods():
    ...
    # you canexperiment with all methods on string in console
...
def rotate_right(input, count):
    ...
    """
    return  input[len(input)-count:]+input[:len(input)-count]  #replace __ with the coder
...
-string slicing
-In python strings can be defined in single quotes,double quotes or multiple quotes
"""
