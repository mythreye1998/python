...
-stopIteration is an exception used to stop iteration when iterator is exhausted
-iterator is used with string,list,tuple,set
-iterator is used to traverse through streams of data
"""