...
-all functions returns an object and functions can act as object ,they can be passed to and returned from any function
-functions with no 'return' statement return an object 'None'
-calling of functions with call-by-object and call-by-sharing
"""