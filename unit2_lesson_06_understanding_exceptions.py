...
-statements under a finally block execute regardless of exception 
-exceptions can have an else block as well in python
-exceptions can be used in python similar to java
"""
