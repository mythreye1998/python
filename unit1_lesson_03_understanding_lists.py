...
-lists can be sorted using built-in sort() function
-lists can store the data of different types
-lists are similar strings with respect to slicing,concatenation etc
"""