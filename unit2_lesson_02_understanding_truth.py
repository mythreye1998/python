...
- 1 or any integer is equivalent to true and 0 is equal to false
-Each data item has an implicit True or False value which may be used implicitly in control flow conditional statements
-None is a first class object of type NoneType
"""
