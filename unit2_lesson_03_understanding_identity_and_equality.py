...
- Python stores small integers in the cache for efficiency and whenever small ints are used, they actually refer to the cached int, not a new object of int
-difference between equality and identity
-how objects are equivalent and equal to each other in python
"""
